package com.example.shafi.criclive.controllers;

import android.support.design.widget.TabLayout;
import android.support.v4.app.FragmentManager;
import android.support.v4.view.ViewPager;

import com.example.shafi.criclive.controllers.adapters.DynamicFragmentAdapter;
...
public class ScorecardSetViews {
    ...
    private void setDynamicFragmentToTabLayout(int numOftabs, ArrayList<Scorecard> scorecardList) {
        ...
        for (int i = 0; i < numOftabs; i++) {
            ...
            mTabLayout.addTab(mTabLayout.newTab().setText("Inning: " + (i+1)));
        }
