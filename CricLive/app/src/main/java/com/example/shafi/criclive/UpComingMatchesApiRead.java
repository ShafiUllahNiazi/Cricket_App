...
public class UpComingMatchesApiRead extends AsyncTask<String, Void, String> {
    ...
    ArrayList<OldMatchesModelClass> lisOldMatches;
    ArrayList<UpcomingMatchesModelClass> listUpcomingMatches;
    UpcomingMatchesAdapter mAdapter;
    TextView textView;

    public UpComingMatchesApiRead(UpcomingMatchesAdapter mAdapter, ArrayList<LiveMatchesModelClass> listliveMatches,ArrayList<OldMatchesModelClass> listOldMatches,ArrayList<UpcomingMatchesModelClass> listUpcomingMatches) {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (matchStarted){
                    if(jsonArray.getJSONObject(i).has("winner_team")){
                        ...
                        lisOldMatches.add(new OldMatchesModelClass(unique_id,date,dateTimeGMT,team_1,team_2,type,squad,toss_winner_team,winner_team,matchStarted));
...
//                putRecyclerVIew();
            ...
            Log.d("sizeeeO",Integer.toString(lisOldMatches.size()));
