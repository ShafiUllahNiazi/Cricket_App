...
public class NewMatches {
    ...
    public NewMatches(long unique_id, String date, String dateTimeGMT, String team_1, String team_2, String type, boolean squad, String toss_winner_team, String winner_team, boolean matchStarted) {
