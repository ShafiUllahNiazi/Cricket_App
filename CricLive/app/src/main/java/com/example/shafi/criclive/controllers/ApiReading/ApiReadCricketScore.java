...
public class ApiReadCricketScore extends AsyncTask<String, Void, String> {
    ...
    public ApiReadCricketScore(Context context, MyAdapter myAdapter, ArrayList<LiveMatchesDescriptiveModelClass> listLive, LiveMatchesModelClass itemOfLiveMatches) {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            databasesInsertData.insertData(listLive,null,null);
