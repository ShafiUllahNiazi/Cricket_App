...
public class ApiRead extends AsyncTask<String, Void, String> {
    ...
    public ApiRead(Context context, SwipeRefreshLayout swipeRefreshLayout, MyAdapter mAdapter, OldMatchAdapter oldMatchAdapter, UpcomingMatchesAdapter upcomingMatchesAdapter, ArrayList<LiveMatchesDescriptiveModelClass> listLive, ArrayList<OldMatchesDescriptiveModelClass> listOld, ArrayList<UpcomingMatchesModelClass> listUpcomingMatches) {
